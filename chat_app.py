...
@st.cache_resource(show_spinner="Creation de la connexion a Mistral")  
def get_response(user_question, chat_history):
    ...
    llm = ChatMistralAI(mistral_api_key=os.environ['MISTRAL_API_KEY'], model_name="open-mistral-7b")
