...
class IndexingPdfData:
    ...
    def __init__(self, dataframe: pd.core.frame.DataFrame) -> None:
        ...
        assert list(dataframe.columns) == ['url', 'type', 'date', 'content', 'file_name', 'file_type', 'file_size']
        self.docs = []
        self.db = None
        ...
        logger.info(f"IndexingPdfData initialised")
    ...
    def create_vector_database(self):
        ...
        logger.info(f"HuggingFace token loaded from .env file")
